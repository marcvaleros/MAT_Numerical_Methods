...
x5
x6=(-1*inv(D))%*%(L+U)%*%x5+inv(D)%*%b
x6
x7=(-1*inv(D))%*%(L+U)%*%x6+inv(D)%*%b
x7
x8=(-1*inv(D))%*%(L+U)%*%x7+inv(D)%*%b
x8
```
...
x2
x3=-inv(L+D)%*%U%*%x2+inv(L+D)%*%b
x3
x4=-inv(L+D)%*%U%*%x3+inv(L+D)%*%b
x4
x5=-inv(L+D)%*%U%*%x4+inv(L+D)%*%b
x5
```
